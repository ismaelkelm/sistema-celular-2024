        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="delete.php?id=<?php echo htmlspecialchars($row['id_cambio']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este cambio?');">Eliminar</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
