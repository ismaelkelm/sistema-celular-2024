...
// Incluir el archivo correspondiente según el rol del usuario
switch ($user_role_id) {
    case 1: // Administrador
        include 'administrador/administrador.php';
        break;
    case 2: // Administrativo
        include 'administrativo/administrativo.php';
        break;
    case 3: // Técnico
        include 'tecnico/tecnico.php';
        break;
    case 4: // Cliente
...
// No se necesita un exit al final porque no estamos redirigiendo, sino incluyendo archivos.
?>
